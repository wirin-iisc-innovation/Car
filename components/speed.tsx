      ...
      <div className="circle-container">
        ...
        <div className="car-container">
          ...
          <div className="svg-composition">
            <img src="/images_speed/Group.svg" alt="Group" className="group-svg" />
            <img src="/images_speed/headlights.svg" alt="Headlight" className="headlight-svg" />
            <img src="/images_speed/Group 427319060.svg" alt="Blue Path" className="blue-path" />
            <img src="/images_speed/Vector 9.svg" alt="White Glow" className="white-glow" />
            <img src="/images_speed/Group 427319053.svg" alt="Car" className="car-image90" />
            <img src="/images_speed/Ellipse.svg" alt="Ellipse" className="ellipse" />
          </div>
        </div>
